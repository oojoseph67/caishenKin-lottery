							...
							>
								<div className="w-full border-b border-gray-100  pb-4">
									<div className="w-full flex justify-between items-start ">
										<div className="items-start ">
											...
											<span className="rounded-full [background:linear-gradient(95.08deg,_#9f2dfe,_#3bb2f9)] px-3 py-3 text-lg font-semibold text-white w-[48px] h-[48px]">
												96
											</span>
										</div>
											...
											<nav aria-label="Page navigation example">
												<ul className="inline-flex text-sm -space-x-px">
													<li>
														<a
															href="#"
															className="inline-flex items-center py-2 px-3 ml-0 mt-0 leading-tight text-gray-500 bg-white rounded-l-lg border border-gray-300 hover:bg-gray-100 hover:text-gray-700 "
														>
															<svg
																aria-hidden="true"
													...
													<li>
														<a
															href="#"
															className="inline-flex items-center py-[10px] px-5 leading-tight text-gray-500 bg-white  hover:bg-gray-100 hover:text-gray-700"
														>
															1
														</a>
													</li>
													<li>
														<a
															href="#"
															className="items-center py-[10px] px-5 leading-tight text-gray-500 bg-white  hover:bg-gray-100 hover:text-gray-700 hidden sm:inline-flex"
														>
															2
														</a>
													</li>
													...
													<li>
														<a
															href="#"
															className="inline-flex items-center py-2 px-3 leading-tight text-gray-500 bg-white rounded-r-lg border border-gray-300 hover:bg-gray-100 hover:text-gray-700 "
														>
															<span className="hidden sm:inline-flex">
																Next
															</span>
								...
								<div className="my-5">
									<div className="flex flex-col sm:flex-row flex-wrap  justify-center  items-center sm:justify-start">
										...
										<div>
											<span className="rounded-full [background:linear-gradient(95.08deg,_#9f2dfe,_#3bb2f9)] px-4 py-3 text-lg font-semibold text-white w-[48px] h-[48px] mr-3">
												9
											</span>
											<span className="rounded-full [background:linear-gradient(95.08deg,_#9f2dfe,_#3bb2f9)] px-4 py-3 text-lg font-semibold text-white w-[48px] h-[48px] mr-3">
												8
											...
											<span className="rounded-full [background:linear-gradient(95.08deg,_#9f2dfe,_#3bb2f9)] px-4 py-3 text-lg font-semibold text-white w-[48px] h-[48px]">
												0
											</span>
										</div>
									</div>
